...
linkela_prefix <- file.path("data", "2023.02.14_LinkELA_")

linkela_users_path <- paste0(linkela_prefix, "users_v4 (anonimizado).xlsx")
linkela_alsfrs_path <- paste0(linkela_prefix, "Formulario-38.xlsx")
...
linkela_alsfrs <- read_xlsx(linkela_alsfrs_path, na = "NULL") %>%
    ...
    mutate(
        ...
        salivation = recode_factor(salivation,
            "Normal." = 4L,
        ...
        swallowing = recode_factor(swallowing,
        ...
        handwriting = recode_factor(handwriting,
            "Normal." = 4L,
        ...
        cutting_nopeg = recode_factor(cutting_nopeg,
            "Normal." = 4L,
        ...
        cutting_peg = recode_factor(cutting_peg,
            "Normal." = 4L,
        ...
        dressing = recode_factor(dressing,
            "Normal." = 4L,
        ...
        orthopnea = recode_factor(orthopnea,
            "Ninguna." = 4L,
        ...
        resp_insuf = recode_factor(resp_insuf,
            "No" = 4L,
            "Ninguna." = 4L,
